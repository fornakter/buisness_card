...
})({"kB0pm":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "6e3bfe4a22989c7d";
...
},{}],"7ZFwe":[function(require,module,exports) {
var _navbarJs = require("./navbar.js");
var _faqJs = require("./faq.js");
(0, _navbarJs.changeNavbar)();
(0, _faqJs.faq)();
document.addEventListener("DOMContentLoaded", ()=>{
    const navb = document.querySelector(".navbar");
    const addShadow = ()=>{
        if (window.scrollY >= 30) navb.classList.add("bg-shadow");
        else navb.classList.remove("bg-shadow");
    };
...
const validateForm = ()=>{
    ...
    const removeWarnings = ()=>{
        inputs.forEach((input)=>input.classList.remove("wrong", "weaker-warning"));
    };
    //check name
    const checkName = ()=>{
        const name = [
        ...
        return name.length <= 0 ? (inputName.classList.add("wrong"), message.push("The name field is empty")) : true;
    };
    //check phone
    const checkPhone = ()=>{
        const phone = [
    ...
    const checkContact = ()=>{
        return chackEmail() || checkPhone() ? true : (message.push("Please leave any contact to you "), inputPhone.classList.add("weaker-warning"), inputEmail.classList.add("weaker-warning"));
    };
    // check message
    const checkMessage = ()=>{
        const text = [
        ...
        return text.length > 0 ? true : (message.push("Message field is empty"), inputMessage.classList.add("wrong"));
    };
    // showing error messages
    const showErrorMessage = ()=>{
        errorField.textContent = "";
        message.forEach((mes)=>errorField.insertAdjacentText("afterbegin", ` *-${mes} `));
    };
...
},{"./navbar.js":"iVcNQ","./faq.js":"2w2EV"}],"iVcNQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "changeNavbar", ()=>changeNavbar);
const changeNavbar = ()=>{
    ...
    navbarMenuDesktop.addEventListener("click", (e)=>{
        ...
        currentPageTracker.style.transform = `translateX(${e.target.dataset.trackerpos * 100}%)`;
    });
};
...
},{}],"2w2EV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kB0pm","7ZFwe"], "7ZFwe", "parcelRequireca99")

//# sourceMappingURL=contact.22989c7d.js.map
