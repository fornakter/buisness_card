...
var _default = new (_plugin().Bundler)({
  ...
  bundle({
    ...
    let assetsToAddOnExit = new (_utils().DefaultMap)(() => []); // Step 1: create bundles for each of the explicit code split points.
      ...
      enter: (node, context, actions) => {
        ...
        for (let asset of assets) {
          ...
          if (existingBundle) {
            ...
            bundleByType.set(bundle.type, bundle);
            bundlesByEntryAsset.set(asset, bundle);
            bundleGraph.createAssetReference(dependency, asset, bundle); // Queue the asset to be added on exit of this node, so we add dependencies first.
