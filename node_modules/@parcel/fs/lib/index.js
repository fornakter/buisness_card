...
class $86a3ba4eb3a17970$export$3048eb7ec07c2c4e {
    ...
    readdirSync(dir, opts) {
        ...
        for (let [filePath1, entry1] of this.files)if (filePath1.startsWith(dir) && filePath1.indexOf((0, ($parcel$interopDefault($ki5hV$path))).sep, dir.length) === -1) {
            let name1 = filePath1.slice(dir.length);
            if (opts === null || opts === void 0 ? void 0 : opts.withFileTypes) res.push(new $86a3ba4eb3a17970$var$Dirent(name1, entry1));
            else res.push(name1);
        }
        for (let [from] of this.symlinks)if (from.startsWith(dir) && from.indexOf((0, ($parcel$interopDefault($ki5hV$path))).sep, dir.length) === -1) {
            ...
            if (opts === null || opts === void 0 ? void 0 : opts.withFileTypes) res.push(new $86a3ba4eb3a17970$var$Dirent(name2, {
    ...
    async ncp(source, destination) {
        ...
        if (this.dirs.has(source)) {
            ...
            for (let [filePath, file] of this.files)if (filePath.startsWith(dir)) {
                let destName1 = (0, ($parcel$interopDefault($ki5hV$path))).join(destination, filePath.slice(dir.length));
