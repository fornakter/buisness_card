...
Parcel\'s default CSS minifer changed from cssnano to @parcel/css, but a "cssnano" key was found in **package.json**. Either remove this configuration, or configure Parcel to use @parcel/optimizer-cssnano instead.
        ...
        message = (0, _diagnostic().md)`Parcel\'s default CSS minifer changed from cssnano to @parcel/css, but a __${filename}__ config file was found. Either remove this config file, or configure Parcel to use @parcel/optimizer-cssnano instead.`;
        codeHighlights = [{
          start: {
            line: 1,
            column: 1
  ...
  async optimize({
    ...
    if (bundle.bundleBehavior === 'inline') {
      ...
      if ((entry === null || entry === void 0 ? void 0 : entry.meta.type) === 'attr') {
        let result = (0, _css().transformStyleAttribute)({
          code,
          minify: true,
          targets
        });
