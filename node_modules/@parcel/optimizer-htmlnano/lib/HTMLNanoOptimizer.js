...
var _default = new (_plugin().Optimizer)({
  async loadConfig({
    ...
    let userConfig = await config.getConfigFrom(_path().default.join(options.projectRoot, 'index.html'), ['.htmlnanorc', '.htmlnanorc.json', '.htmlnanorc.js', '.htmlnanorc.cjs', 'htmlnano.config.js', 'htmlnano.config.cjs'], {
      packageKey: 'htmlnano'
    });
