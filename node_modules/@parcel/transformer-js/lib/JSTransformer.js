  ...
  async transform({
    ...
    if (hoist_result) {
      ...
      let deps = new Map(asset.getDependencies().map(dep => {
        ...
        return [(_dep$meta$placeholder = dep.meta.placeholder) !== null && _dep$meta$placeholder !== void 0 ? _dep$meta$placeholder : dep.specifier + (dep.specifierType === 'esm' ? dep.specifierType : ''), dep];
      }));
      ...
      if (symbol_result) {
        let deps = new Map(asset.getDependencies().map(dep => {
          ...
          return [(_dep$meta$placeholder2 = dep.meta.placeholder) !== null && _dep$meta$placeholder2 !== void 0 ? _dep$meta$placeholder2 : dep.specifier + (dep.specifierType === 'esm' ? dep.specifierType : ''), dep];
        }));
        asset.symbols.ensure();
